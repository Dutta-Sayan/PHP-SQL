...
if(isset($_POST['submit'])) {
  ...
  $empCodeOriginal = $_POST['employeeCodeOriginal'];
  $empIdOriginal = $_POST['employeeIdOriginal'];
  ...
  $idErr=="" && $domainErr=="" && $salaryErr=="" && $percentileErr=="") {
    $conn->updateCodeTable($empCodeOriginal,$empCode, $empCodeName, $empDomain);
    $conn->updateSalaryTable($empId, $empSalary, $empCode, $empCodeOriginal);
    $conn->updateDetailsTable($empIdOriginal, $empId, $empFname, $empLname, $empPercentile);
