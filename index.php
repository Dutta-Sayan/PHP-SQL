    ...
    <div class="container">
      ...
      <form class="user-registration-form" action="index.php" method="post">
        ...
        <div class="form-input">
          <input class=" username form-control" type="text" name="uname" placeholder="User Name" value="<?php echo $username?>" maxlength=25 pattern="^[a-zA-Z_ ]{1,25}$" required>
        </div>

        <div class="form-input">
          <input class="email form-control" type="email" name="email" placeholder="Email" value="<?php echo $email?>" required>
        </div>

        <div class="form-input">
          <input class="password form-control" type="password" name="password" maxlength=30 placeholder="Password (Minimum 8 and maximum 30 characters)"  value="<?php echo $password?>" required>
        </div>

        <div class="form-input">
          <input class="form-control" type="password" name="rpassword" maxlength=30 value="<?php echo $retypePassword?>" placeholder="Retype password" required>
        </div>
